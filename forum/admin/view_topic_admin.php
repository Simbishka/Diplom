   ...
   ?>
    ...
    <div id="content">
        <?php
          $id=$_GET['id'];
          $cid = $_GET['cid'];
          echo "<a href='view_category_admin.php?cid=".$cid."'>Назад</a>";
          $tid = $_GET['tid'];
          ...
          if (mysqli_num_rows($res) == 1) {
            ...
            if ($_SESSION['user']) {
              echo "<tr><td colspan='2'><input type='submit' value='Добавить ответ' onClick=\"window.location = 'post_reply_admin.php?cid=".$cid."&tid=".$tid."'\" />";
            }
            ...
            while ($row = mysqli_fetch_assoc($res)){
              ...
              while($row2 = mysqli_fetch_assoc($res2)) {
                ...
                <table class='post_del'><tr><td><a href='del_post.php?id=".$row2['id']."'>Удалить</a></td></tr></table>
                ";
    ...
    <input type="hidden" name="tid" value="<?php echo $aid; ?>" />
