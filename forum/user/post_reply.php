...
<div class="wrapper">
   <?php
      echo "<p class='authed_as'>Вы вошли как ".$_SESSION['user']['full_name']." &bull; <a href='../../logout.php'>Выйти</a>";
   ?>
    <div id="content">
      <form class='post_reply_user_form' action="post_reply_parse.php" method="post">
      ...
      <a href="view_topic.php?cid=<?php echo $cid;?>&tid=<?php echo $tid;?>">Назад</a>
    </div>
